                  ...
                  <div className="icon-iconfeatherawar">
                    <div className="icon">
                      <div className="overlap-group-1">
                        ...
                        <img className="a230cb3d-e700-48a5-a760-c060353cfdfa" src={a230Cb3DE70048A5A760C060353Cfdfa} />
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="footer">
          <div className="flex-row">
            <div className="flex-col">
              ...
              <p className="description-stylestyle3tagp poppins-normal-star-dust-16px">{descriptionStyleStyle3TagP}</p>
              <div className="circle-button-size-container">
                <div className="circle-button-sizeme-1">
                  <div className="icon-iconfeather">
                    <div className="icon-1">
                      <img className="x35fedd9c-5bbc-449b-91d1-5ce70336a6b0" src={x35Fedd9C5Bbc449B91D15Ce70336A6B0} />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="icon-iconfeather">
                    <div className="icon-3">
                      ...
                      <div className="flex-row-1">
                        ...
                        <img className="d90e54ec-6bd2-4ff1-9c20-bcb6c571d34b" src={d90E54Ec6Bd24Ff19C20Bcb6C571D34B} />
                      </div>
                    </div>
                  </div>
                </div>
